...
from model.drmmrank import DRMMrank,DrmmRankDataloader
...
if __name__=="__main__":
    ...
    data_loader = DrmmRankDataloader(bin=0.5,
                 querynum=5,
                 idf_file=idf_file,
                 embedfile=embedfile,
                 queryfile=queryfile,
    ...
    model = DRMMrank(train_flag=True,model_path = model_path,batch_size=32)
